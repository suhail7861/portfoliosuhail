  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      "template_7mu5ckd",
      {
        ...
        to_email: "suhailarijith999@@gmail.com",
        ...
        >
          <label className='flex flex-col'>
            ...
            <input type="text" name="name" id=""
              ...
              className='bg-tertiary py-4 px-6 placdeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
          <label className='flex flex-col'>
